...
<p align="center">
  یک داشبورد حرفه‌ای RTL برای مدیریت پورتفولیوی سهام بورس ایران و ارز دیجیتال. 
...
- اضافه/ویرایش/حذف سهام و ارز در هر پورتفولیو
...
> بدون نیاز به SSH! فقط با مرورگر نصب کنید.

### مرحله ۱: ساخت فایل deploy
...
اسکریپت از شما دامنه می‌پرسد و خودکار فایل‌ها را build و آماده می‌کند.
