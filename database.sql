...
CREATE TABLE `portfolio_items` (
  ...
  `notification_cooldown_minutes` int(10) unsigned NOT NULL DEFAULT 10,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `portfolio_daily_sms_log` (
  ...
  CONSTRAINT `portfolio_daily_sms_log_portfolio_sms_setting_id_foreign` FOREIGN KEY (`portfolio_sms_setting_id`) REFERENCES `portfolio_sms_settings` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
