...
DROP TABLE IF EXISTS `crossover_notifications`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `portfolio_item_transactions`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `portfolio_item_transactions` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  ...
  `resulting_quantity` decimal(12,4) DEFAULT NULL,
  `resulting_avg_price` decimal(12,2) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `portfolio_item_transactions_portfolio_item_id_created_at_index` (`portfolio_item_id`,`created_at`),
  KEY `portfolio_item_transactions_portfolio_id_index` (`portfolio_id`),
  CONSTRAINT `portfolio_item_transactions_portfolio_id_foreign` FOREIGN KEY (`portfolio_id`) REFERENCES `portfolios` (`id`) ON DELETE CASCADE,
  CONSTRAINT `portfolio_item_transactions_portfolio_item_id_foreign` FOREIGN KEY (`portfolio_item_id`) REFERENCES `portfolio_items` (`id`) ON DELETE CASCADE
...
CREATE TABLE `portfolio_items` (
  ...
  `prev_last_price` decimal(12,2) DEFAULT NULL,
  ...
  `notification_cooldown_minutes` int(11) NOT NULL DEFAULT 10,
